...
namespace BE.API.Controllers
{
    ...
    public class HumanResourcesController : ControllerBase
    {
        ...
        [RequirePermission(PermissionCodes.HrAccountCreate), HttpPost("directory-employees")] public Task<IActionResult> CreateDirectoryEmployee(CreateDirectoryEmployeeRequest r) => Run(async () => Ok(await _service.CreateDirectoryEmployee(r, UserName)));
